...
export default function AlbumCard({ album }) {
  ...
  return (
    <div className="bg-white shadow-lg rounded-2xl p-4 flex flex-col relative max-w-xs w-full mx-auto">
      {/* EDIT & DELETE BUTTONS */}
      ...
      <div className="flex flex-col flex-grow text-center">
        <h2 className="text-lg font-bold text-blue-900 truncate">{album.name || 'Untitled Album'}</h2>
        <p className="text-gray-700 text-sm mb-1 truncate">By {album.artist_name || 'Unknown Artist'}</p>
        <p className="text-green-600 font-semibold text-sm mb-3">NPR {album.price}</p>
